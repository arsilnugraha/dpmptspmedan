      ...
      <div class='col-xs-12'>
         <div class='box'>
            <div class='box-header with-border'>
               <h3 class='box-title'><b> Daftar Berita Kios OSS</b></h3>
            </div>
            <div class='box-body'>
               <div class='form-group'>
                  
                     <a class='btn btn-success btn-sm' href='<?php echo base_url('panel/module/pelayanan/kiososs/tambah')?>'><i class='fa fa-plus'></i> Add</a>
               ...
               <table id="datatable_ajax" class="table table-bordered table-striped" width="100%">
                  <thead style='background:#428bca;color:#fff;'>
                     <tr>
                        ...
                        <th style="text-align:center;">Judul Berita Kios OSS</th>
