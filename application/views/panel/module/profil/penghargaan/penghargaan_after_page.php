<script type="text/javascript">
    ...
    TableAjax = function() {
        var handleRecords = function() {
            table = $('#datatable_ajax').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo site_url('panel/module/profil/penghargaan/ajax_list') ?>",
                    "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $('#form').submit(function(e) {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('panel/module/profil/penghargaan/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('panel/module/profil/penghargaan/ajax_update') ?>";
            }
    ...
    function edit_penghargaan(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('panel/module/profil/penghargaan/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id);
                ...
                if(file_foto) {
                  var fileUrl  = '<?php echo base_url("/assets/foto_penghargaan/") ?>' + file_foto;
    ...
    function delete_penghargaan(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('panel/module/profil/penghargaan/ajax_delete/') ?>" + id,
                type: "GET",
                dataType: "JSON",
                data: function(dtRequest) {
                    dtRequest['<?php echo $this->security->get_csrf_token_name(); ?>'] = '<?php echo $this->security->get_csrf_hash(); ?>';
            ...
            <div class="modal-body form">
                ...
                <div class="form-body">
                    <div class='form-group'>
                        <label class='col-sm-4 control-label'>Foto Penghargaan :</label>
                        <div class='col-sm-8'>
