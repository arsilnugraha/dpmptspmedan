      ...
      <div class='col-xs-12'>
         <div class='box'>
            <div class='box-header with-border'>
               <h3 class='box-title'><b> Daftar Portal</b></h3>
            </div>
            <div class='box-body'>
               <div class='form-group'>     
                  <button class="btn btn-success btn-sm" onclick="add_portal()"><i class="fa fa-plus"></i> Add</button>
               ...
               <table id="datatable_ajax" class="table table-bordered table-striped" width="100%">
                  <thead style='background:#428bca;color:#fff;'>
                     <tr>
                        ...
                        <th style='width:20%;text-align:center'>Nama Portal</th>
