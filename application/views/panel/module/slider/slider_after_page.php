<script type="text/javascript">
    ...
    TableAjax = function() {
        var handleRecords = function() {
            table = $('#datatable_ajax').DataTable({
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo site_url('panel/module/slider/ajax_list') ?>",
                    "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $('#form').submit(function(e) {
            ...
            if (save_method == 'add') {
                url = "<?php echo site_url('panel/module/slider/ajax_add') ?>";
            } else {
                url = "<?php echo site_url('panel/module/slider/ajax_update') ?>";
            }
    ...
    function edit_slider(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('panel/module/slider/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id);
                ...
                if(file_logo) {
                  var fileUrl  = '<?php echo base_url("/assets/image_slider/") ?>' + file_logo;
    ...
    function delete_slider(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('panel/module/slider/ajax_delete/') ?>" + id,
                type: "GET",
                dataType: "JSON",
                data: function(dtRequest) {
                    dtRequest['<?php echo $this->security->get_csrf_token_name(); ?>'] = '<?php echo $this->security->get_csrf_hash(); ?>';
