      ...
      <div class='col-md-12'>
        <div class='box box-info'>
          <div class='box-header with-border'>
            <h3 class='box-title'><span class='glyphicon glyphicon-edit'></span><b> Form Tambah Data Berita</b></h3>
          </div>
          <div class='box-body'>
            <form class='form-horizontal' role='form' method=POST action='<?php echo base_url('panel/module/berita/tambah/do_create')?>' enctype='multipart/form-data'>
