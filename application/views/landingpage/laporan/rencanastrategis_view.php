<section id="page-title">
    <div class="container clearfix">
        <h1>RENSTRA</h1>
        <span>Rencana Strategis (RENSTRA)</span>
        <br>
    </div>
</section>
<section id="content">
                ...
                <div class="single-post mb-0">
                    <div class="entry clearfix">
                        <div class="entry-content mt-0">
                            <a href="<?php echo base_url('assets/landingpage/') ?>public/media/renstra_full.pdf">
                                <h4><u>Rencana Strategis (RENSTRA) Tahun 2016-2021</u></h4>
                            </a>
                            <a href="<?php echo base_url('assets/landingpage/') ?>public/media/renstra-2021-2026.pdf">
                                <h4><u>Rencana Strategis (RENSTRA) Tahun 2021-2026</u></h4>
                            </a>
                        </div>
                    </div>
                </div>
