<section id="page-title">
    <div class="container clearfix">
        <h1>Laporan Kompensasi Pelayanan</h1>
        <span>SK Kompensasi Pelayanan</span>
        <br>
    </div>
</section>
<section id="content">
                ...
                <div class="single-post mb-0">
                    <div class="entry clearfix">
                        <div class="entry-content mt-0">
                            <a href="<?php echo base_url('assets/landingpage/') ?>public/media/files/kompensasi-penilaian/sk-kompensasi-pelayanan.pdf"><u><h4>SK Kompensasi Pelayanan</h4></u></a>
                        </div>
                    </div>
                </div>
            </div>
