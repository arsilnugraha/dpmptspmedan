<section id="page-title">
    <div class="container clearfix">
        <h1>Laporan</h1>
        <span>Laporan Reward and Punishment ASN</span>
        <br>
    </div>
</section>
<section id="content">
                ...
                <div class="single-post mb-0">
                    <div class="entry clearfix">
                        <div class="entry-content mt-0">
                            <a href="<?php echo base_url('assets/landingpage/') ?>public/media/files/lap-reward-asn-2019.pdf"><u><h4>Reward dan punishment asn tahun 2019</h4></u></a>
                        </div>
                    </div>
                </div>
            </div>
