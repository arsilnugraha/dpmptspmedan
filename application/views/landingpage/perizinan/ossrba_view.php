                ...
                <div class="single-post mb-0">
                    <div class="entry clearfix">
                        <div class="entry-image">
                            <img href="<?php echo base_url('assets/landingpage/'); ?>public/media/files/oss-rba/oss-rba.jpg">
                                <img src="<?php echo base_url('assets/landingpage/'); ?>public/media/files/oss-rba/oss-rba.jpg" alt="OSS RBA">
                            </img>
                        </div>
                    </div>
                </div>
