    ...
    <div class="content-wrap">
        <div class="container">
            ...
            <?php foreach ($penghargaan as $row) { ?>      
                <a class="grid-item" href="<?php echo base_url('assets/foto_penghargaan/'. $row->foto) ?>" data-lightbox="gallery-item">
                    <img src="<?php echo base_url('assets/foto_penghargaan/'. $row->foto) ?>" alt="Sarana Layanan DPMPTSP Medan">
                </a>
            <?php } ?>      
            </div>
        </div>
