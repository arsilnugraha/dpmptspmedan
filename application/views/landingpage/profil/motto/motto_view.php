                ...
                <div class="single-post mb-0">
                    <div class="entry clearfix">
                        <div class="entry-image">
                            <a href="<?php echo base_url('assets/landingpage/') ?>public/media/files/motto.jpg">
                                <img src="<?php echo base_url('assets/landingpage/') ?>public/media/files/motto.jpg" alt="DPMPTSP Medan">
                            </a>
                        </div>
                    </div>
                </div>
