                ...
                <div class="single-post mb-0">
                    <div class="entry clearfix">
                        <div class="entry-image">
                            <a href="<?php echo base_url('assets/landingpage/') ?>public/media/files/maklumat.jpg">
                                <img src="<?php echo base_url('assets/landingpage/') ?>public/media/files/maklumat.jpg" alt="DPMPTSP Medan">
                            </a>
                        </div>
                    </div>
                </div>
