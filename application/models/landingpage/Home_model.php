...
class Home_model extends CI_Model
{
  ...
  function limit_berita_order_by($table, $order_by, $order ,$limit)
  {
    return $this->db->query("SELECT * FROM $table WHERE status = 'Y' ORDER BY $order_by $order LIMIT $limit")->result();
  }
}
?>
