...
class Submenu extends CI_Controller {
   public function __construct()
   {
          ...
          $this->load->model('panel/module/pengaturan/submenu_model','dbObject');
   }

   public function index() {
      $output['judul_besar'] = 'Pengaturan';
		$output['judul_kecil'] = 'Sub Menu';
		$output['menu_aktif'] = 'm_submenu';
		$output['parent_master'] = 'active open';
		$output['menu'] = $this->dbObject->get_general('pengaturan_menu');
		$output['icon'] = 'fa fa-cog';
		$output['content'] = 'panel/module/pengaturan/submenu/submenu_view';
		$output['after_page'] = 'panel/module/pengaturan/submenu/submenu_after_page';
   ...
   public function ajax_list()
	...
	{
      $data = array(
         'nama_submenu' => $this->input->post('sub_menu'),
